...
start-backend:
	...
	@poetry run uvicorn openhands.app_server.app:app --host $(BACKEND_HOST) --port $(BACKEND_PORT) --reload --reload-exclude "./workspace"
...
_run_setup:
	...
	@poetry run uvicorn openhands.app_server.app:app --host $(BACKEND_HOST) --port $(BACKEND_PORT) &
